package me.jincrates.claimservice.intg.api.controller;
...
import me.jincrates.claimservice.intg.ControllerTestSupport;
...
class ClaimControllerTest extends ControllerTestSupport {
    ...
    void claimReasonIsProductDefectsAndImageIdListIsNull() throws Exception {
        ...
        ClaimCreateRequest request = ClaimCreateRequest.builder()
                ...
                .memo(String.format("%s(으)로 인한 %s입니다.", ClaimReason.PRODUCT_DEFECTS.getDescription(), ClaimType.RETURN.getDescription()))
                .claimProducts(List.of(
                                ClaimProductRequest.builder()
                                        .orderProductId(1L)
                                        .quantity(5)
